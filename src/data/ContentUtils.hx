							...
							new SectionCells({
								...
								cells: [
									new TextCell({
										...
										gridRow: 'span 2',
										bgcolor: '#0F154D',
										/*bgimage:'/assets/home/background.jpg',*/
										url: '/content/room0/shelf1/book2',
										text: '#Välkommen till Körakademin hösten 2018!                        
...
'
					...
					shelves: [
										...
										new Chapter({
											...
											subchapters: [
												...
												new Chapter({
													...
													title: 'Pdf',
													access: 0,
													type: new PdfChaptertype()
												}),
												new Chapter({
													id: 'ros0',
													title: 'Rosetta',
													access: 0,
													type: new RosettaChaptertype()
												}),
												new Chapter({
													id: 'pitch1',
													title: 'Pitch',
						...
						new Shelf({
							id: 'shelf1',
							title: 'Ytterligare en bokhylla',
							access: 0,
							books: [
								new Book({
									id: 'book2',
									title: 'En bok bland alla andra',
									access: 0,
									chapters: [
										new Chapter({
											id: 'chapter0',
