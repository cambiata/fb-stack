...
enum abstract Access(Int) to Int  {
    var Guest = 1;
    var Admin = 2;
    inline public function new(v:Int) this = cx.AbstractEnumTools.getValues(Access).indexOf(cast v) > -1 ? v : {throw 'Value Error $v!'; 1;};
    @:from static public function fromInt(v:Int) return new Access(v); 
}
