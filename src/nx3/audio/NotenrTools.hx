...
class NotenrTools {
	...
	*/
	...
	static public function addMetronome(partsnotes:PartsNotenrItems):PartsNotenrItems {
		var metronomePart:NotenrItems = [];
		
		var firstnote:NotenrItem = createNotenrItem(partsnotes.length, 0, 3042, 100, 0, 72, null, null, null, null, null, true, partsnotes.length, 0, 0, null); 
		
		
		metronomePart.push(firstnote);
		
		partsnotes.push(metronomePart);
		return partsnotes;
