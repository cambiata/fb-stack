...
var Main = function() {
	new nx3_qs_QSParser("|4/4 /### a+ p8 b-,d A2 | c+ e8 b_ b16 g a e +f8. d16 | e2.,A p4").parse();
...
Index.prototype = {
	view: function() {
		...
		return [m.m("h1","Hello from Mithril"),new RenderScore("|4/4 /### a+ p8 b-,d A2 | c+ e8 b_ b16 g a e +f8. d16 | e2.,A p4").view()];
	}
	,__class__: Index
};
var RenderScore = function(qs) {
	this.qs = qs;
};
RenderScore.__name__ = ["RenderScore"];
RenderScore.__interfaces__ = [mithril_Mithril];
RenderScore.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		var parser = new nx3_qs_QSParser(this.qs);
		...
		return [m.m("nisse",this.qs),m.m("test","Hello"),m.trust(haxe_xml_Printer.print(target.getXml()))];
	}
	,__class__: RenderScore
};
Math.__name__ = ["Math"];
...
nx3_qs_QSExamples.run = function() {
	...
	console.log("../../../cx/src/nx3/qs/QSParser.hx:39:",haxe_xml_Printer.print(nx3_xml_ScoreXML.toXml(nscore)));
};
...
nx3_qs_QSParser.prototype = {
		...
		while(_g < matrix.length) {
			...
			if(partLength != firstLenght) {
				while(partLength < firstLenght) {
					...
					++partLength;
					console.log("../../../cx/src/nx3/qs/QSParser.hx:350:","Inconsistent part numbers: " + firstLenght + " " + partLength + " " + this.str);
				}
				return false;
			}
		}
	...
	,createMatrix: function(tokens) {
		...
		try {
			while(nx3_qs_ArrTools.last(nx3_qs_ArrTools.last(nx3_qs_ArrTools.last(matrix2).parts).voices).notes.length == 0) {
				console.log("../../../cx/src/nx3/qs/QSParser.hx:415:","pop");
				matrix2.pop();
			}
		} catch( e ) {
			console.log("../../../cx/src/nx3/qs/QSParser.hx:419:",(e instanceof js__$Boot_HaxeError) ? e.val : e);
		}
		return matrix2;
	}
	...
	,traceCurrent: function(str) {
		...
		console.log("../../../cx/src/nx3/qs/QSParser.hx:436:","" + this.barIdx + ":" + this.partIdx + ":" + this.voiceIdx + ":" + this.noteIdx + " : " + str);
	}
	...
	,drawBarlines: function(system,systembars) {
		...
		while(_g < systembars.length) {
			...
			while(_g1 < _g2.length) {
				...
				if(part1.npart.type._hx_index == 0) {
...
nx3_render_TargetSvgXml.prototype = {
	...
	,textwidth: function(text) {
		if(this.context == null) {
			...
			if(canvas == null) {
				console.log("../../../cx/src/nx3/render/TargetSvgXml.hx:379:","creating a canvas for text measurement");
...
nx3_xml_BarXML.test = function(item) {
	...
	console.log("../../../cx/src/nx3/xml/BarXML.hx:102:",str);
	console.log("../../../cx/src/nx3/xml/BarXML.hx:103:",str2);
	return str == str2;
};
...
nx3_xml_HeadXML.test = function(item) {
	...
	console.log("../../../cx/src/nx3/xml/HeadXML.hx:152:",str);
	console.log("../../../cx/src/nx3/xml/HeadXML.hx:153:",str2);
	return str == str2;
};
...
nx3_xml_NoteXML.test = function(item) {
	...
	console.log("../../../cx/src/nx3/xml/NoteXML.hx:245:",str);
	console.log("../../../cx/src/nx3/xml/NoteXML.hx:246:",str2);
	return str == str2;
};
...
nx3_xml_VoiceXML.test = function(item) {
	...
	console.log("../../../cx/src/nx3/xml/VoiceXML.hx:76:",str);
	console.log("../../../cx/src/nx3/xml/VoiceXML.hx:77:",str2);
	return str == str2;
};
