...
class ScrollerPage extends HTMLElement { 
    constructor() {
        super();
...
window.customElements.define('scroller-page', ScrollerPage)

class ScrollerMain extends HTMLElement { 
    constructor() {
        super();
        // console.log('scroller-main created');
    }

    connectedCallback() {       
        // console.log('scroller-main connected');
    }
}
window.customElements.define('scroller-main', ScrollerMain)
