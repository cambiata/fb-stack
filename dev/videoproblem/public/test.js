...
var Main = function() {
	var videochapter = new ui_VideoChapter(new data_VideoChaptertype({ url : "/assets/tada.mp4"}));
	m.mount(window.document.body,new Index(videochapter));
};
$hxClasses["Main"] = Main;
Main.__name__ = ["Main"];
Main.main = function() {
...
var Index = function(videochapter) {
...
Index.prototype = {
	view: function() {
		...
		return [m.m("h1","Hello from Mithril"),m.m("video",{ controls : true, src : "/assets/tada.mp4"})];
	}
	,__class__: Index
};
Math.__name__ = ["Math"];
