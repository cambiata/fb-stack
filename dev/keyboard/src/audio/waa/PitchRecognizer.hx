...
class PitchRecognizer {	
	...
	var initialized:Bool = false;
	 ...
	 function init(cbk:Dynamic, audioContext:AudioContext) {
		 ...
		 if (this.initialized) {
			 Browser.alert('PitchRecognizer already initialized');
			 return;
		 }
	...
	untyped __js__ ('	
		...
		*/
		...
		navigator.getUserMedi = navigator.mediaDevices.getUserMedia;

		navigator.mediaDevices.getUserMedia({audio: true}, gotStream, function(err) {
			console.log(err);
		});	
