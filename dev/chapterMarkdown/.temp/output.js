...
Index.prototype = {
	view: function() {
		...
		return [m.m("h1","Hello from Mithril"),m.m("textarea",{ style : { width : "300px", height : "200px"}, value : State.md, oninput : function(e) {
			return State.md = e.target.value;
		}}),markdown_MarkdownRenderer.instance.markdownToView(State.md,[new markdown_QInlineSyntaxRenderer()])];
	}
	,__class__: Index
};
...
var markdown_MarkdownRenderer = function() {
	this.syntaxRenderers = [];
};
markdown_MarkdownRenderer.__name__ = ["markdown","MarkdownRenderer"];
markdown_MarkdownRenderer.prototype = {
	...
	,buildView: function(mdNodes,parent) {
		...
		while(_g < mdNodes.length) {
			...
			case markdown_ast_ErrorNode:
				...
				break;
			default:
				console.log("src/markdown/MarkdownRenderer.hx:115:","found other node: " + Std.string(mdNode));
				var dataNode = [mdNode];
				console.log("src/markdown/MarkdownRenderer.hx:117:",dataNode[0].tag);
				try {
					var syntaxRenderer = this.syntaxRenderers.filter((function(dataNode1) {
						return function(sr) {
							return dataNode1[0].tag == Type.getClassName(sr == null ? null : js_Boot.getClass(sr));
						};
					})(dataNode))[0];
					console.log("src/markdown/MarkdownRenderer.hx:123:",syntaxRenderer);
					syntaxRenderer.render(parent,dataNode[0].data);
				} catch( e ) {
					console.log("src/markdown/MarkdownRenderer.hx:130:","error: " + Std.string((e instanceof js__$Boot_HaxeError) ? e.val : e));
				}
			}
		}
		return parent;
	}
	,__class__: markdown_MarkdownRenderer
};
var markdown_InlineSyntaxRenderer = function(pattern) {
	markdown_InlineSyntax.call(this,pattern);
};
markdown_InlineSyntaxRenderer.__name__ = ["markdown","InlineSyntaxRenderer"];
markdown_InlineSyntaxRenderer.__super__ = markdown_InlineSyntax;
markdown_InlineSyntaxRenderer.prototype = $extend(markdown_InlineSyntax.prototype,{
	render: function(parent,code) {
		parent.children.push({ tag : "h1", attrs : { className : "error"}, text : ["InlineSyntaxRenderer"]});
	}
	,__class__: markdown_InlineSyntaxRenderer
});
var markdown_QSyntax = function() {
	markdown_InlineSyntax.call(this,markdown_QSyntax.REGEX);
};
markdown_QSyntax.__name__ = ["markdown","QSyntax"];
markdown_QSyntax.__super__ = markdown_InlineSyntax;
markdown_QSyntax.prototype = $extend(markdown_InlineSyntax.prototype,{
	onMatch: function(parser) {
		var code = this.pattern.matched(1);
		console.log("src/markdown/MarkdownRenderer.hx:160:","found QSyntax: " + code);
		parser.addNode(new markdown_ast_DataNode("QSyntax",code));
		return true;
	}
	,__class__: markdown_QSyntax
});
var markdown_QInlineSyntaxRenderer = function() {
	markdown_InlineSyntaxRenderer.call(this,markdown_QInlineSyntaxRenderer.REGEX);
};
markdown_QInlineSyntaxRenderer.__name__ = ["markdown","QInlineSyntaxRenderer"];
markdown_QInlineSyntaxRenderer.__super__ = markdown_InlineSyntaxRenderer;
markdown_QInlineSyntaxRenderer.prototype = $extend(markdown_InlineSyntaxRenderer.prototype,{
	onMatch: function(parser) {
		var code = this.pattern.matched(1);
		console.log("src/markdown/MarkdownRenderer.hx:180:","found QSyntax: " + code);
		parser.addNode(new markdown_ast_DataNode(Type.getClassName(js_Boot.getClass(this)),code));
		return true;
	}
	,render: function(parent,code) {
		var renderer = ui_StringRendererMapper.instance.get("score");
		console.log("src/markdown/MarkdownRenderer.hx:189:",renderer.renderFromCode(code));
	...
	,__class__: markdown_QInlineSyntaxRenderer
});
...
var nx3_EAllotment = $hxEnums["nx3.EAllotment"] = { __ename__ : true, __constructs__ : ["LeftAlign","Equal","Logaritmic","Linear"]
	,LeftAlign: {_hx_index:0,__enum__:"nx3.EAllotment"}
	,Equal: {_hx_index:1,__enum__:"nx3.EAllotment"}
	,Logaritmic: {_hx_index:2,__enum__:"nx3.EAllotment"}
	,Linear: {_hx_index:3,__enum__:"nx3.EAllotment"}
};
var nx3_EBarType = $hxEnums["nx3.EBarType"] = { __ename__ : true, __constructs__ : ["Normal","Repeat","Ignore","Folded"]
	,Normal: {_hx_index:0,__enum__:"nx3.EBarType"}
	,Repeat: {_hx_index:1,__enum__:"nx3.EBarType"}
	,Ignore: {_hx_index:2,__enum__:"nx3.EBarType"}
	,Folded: {_hx_index:3,__enum__:"nx3.EBarType"}
};
var nx3_EBarline = $hxEnums["nx3.EBarline"] = { __ename__ : true, __constructs__ : ["Normal","None","Double","Final","Dotted","Breath","EndRepeat","EndAndStartRepeat"]
	,Normal: {_hx_index:0,__enum__:"nx3.EBarline"}
	,None: {_hx_index:1,__enum__:"nx3.EBarline"}
	,Double: {_hx_index:2,__enum__:"nx3.EBarline"}
	,Final: {_hx_index:3,__enum__:"nx3.EBarline"}
	,Dotted: {_hx_index:4,__enum__:"nx3.EBarline"}
	,Breath: {_hx_index:5,__enum__:"nx3.EBarline"}
	,EndRepeat: {_hx_index:6,__enum__:"nx3.EBarline"}
	,EndAndStartRepeat: {_hx_index:7,__enum__:"nx3.EBarline"}
};
var nx3_EBarlineLeft = $hxEnums["nx3.EBarlineLeft"] = { __ename__ : true, __constructs__ : ["None","Single","Double","StartRepeat"]
	,None: {_hx_index:0,__enum__:"nx3.EBarlineLeft"}
	,Single: {_hx_index:1,__enum__:"nx3.EBarlineLeft"}
	,Double: {_hx_index:2,__enum__:"nx3.EBarlineLeft"}
	,StartRepeat: {_hx_index:3,__enum__:"nx3.EBarlineLeft"}
};
var nx3_EBeamflagType = $hxEnums["nx3.EBeamflagType"] = { __ename__ : true, __constructs__ : ["None","Start16","End16","Full16"]
	,None: {_hx_index:0,__enum__:"nx3.EBeamflagType"}
	,Start16: {_hx_index:1,__enum__:"nx3.EBeamflagType"}
	,End16: {_hx_index:2,__enum__:"nx3.EBeamflagType"}
	,Full16: {_hx_index:3,__enum__:"nx3.EBeamflagType"}
};
var nx3_EClef = $hxEnums["nx3.EClef"] = { __ename__ : true, __constructs__ : ["ClefG","ClefF","ClefC"]
	,ClefG: {_hx_index:0,__enum__:"nx3.EClef"}
	,ClefF: {_hx_index:1,__enum__:"nx3.EClef"}
	,ClefC: {_hx_index:2,__enum__:"nx3.EClef"}
};
...
var nx3_EDirectionUAD = $hxEnums["nx3.EDirectionUAD"] = { __ename__ : true, __constructs__ : ["Up","Auto","Down"]
	,Up: {_hx_index:0,__enum__:"nx3.EDirectionUAD"}
	,Auto: {_hx_index:1,__enum__:"nx3.EDirectionUAD"}
	,Down: {_hx_index:2,__enum__:"nx3.EDirectionUAD"}
};
...
var nx3_EDirectionUD = $hxEnums["nx3.EDirectionUD"] = { __ename__ : true, __constructs__ : ["Up","Down"]
	,Up: {_hx_index:0,__enum__:"nx3.EDirectionUD"}
	,Down: {_hx_index:1,__enum__:"nx3.EDirectionUD"}
};
...
var nx3_EDisplayALN = $hxEnums["nx3.EDisplayALN"] = { __ename__ : true, __constructs__ : ["Always","Layout","Never"]
	,Always: {_hx_index:0,__enum__:"nx3.EDisplayALN"}
	,Layout: {_hx_index:1,__enum__:"nx3.EDisplayALN"}
	,Never: {_hx_index:2,__enum__:"nx3.EDisplayALN"}
};
var nx3_EHeadPosition = $hxEnums["nx3.EHeadPosition"] = { __ename__ : true, __constructs__ : ["Left","Center","Right"]
	,Left: {_hx_index:0,__enum__:"nx3.EHeadPosition"}
	,Center: {_hx_index:1,__enum__:"nx3.EHeadPosition"}
	,Right: {_hx_index:2,__enum__:"nx3.EHeadPosition"}
};
var nx3_EHeadType = $hxEnums["nx3.EHeadType"] = { __ename__ : true, __constructs__ : ["Normal","Rythmic","Crossed","Pause","Other"]
	,Normal: {_hx_index:0,__enum__:"nx3.EHeadType"}
	,Rythmic: {_hx_index:1,__enum__:"nx3.EHeadType"}
	,Crossed: {_hx_index:2,__enum__:"nx3.EHeadType"}
	,Pause: {_hx_index:3,__enum__:"nx3.EHeadType"}
	,Other: {_hx_index:4,__enum__:"nx3.EHeadType"}
};
var nx3_EHeadValueType = $hxEnums["nx3.EHeadValueType"] = { __ename__ : true, __constructs__ : ["HVT4","HVT2","HVT1"]
	,HVT4: {_hx_index:0,__enum__:"nx3.EHeadValueType"}
	,HVT2: {_hx_index:1,__enum__:"nx3.EHeadValueType"}
	,HVT1: {_hx_index:2,__enum__:"nx3.EHeadValueType"}
};
var nx3_EKey = $hxEnums["nx3.EKey"] = { __ename__ : true, __constructs__ : ["Sharp6","Sharp5","Sharp4","Sharp3","Sharp2","Sharp1","Natural","Flat1","Flat2","Flat3","Flat4","Flat5","Flat6"]
	,Sharp6: {_hx_index:0,__enum__:"nx3.EKey"}
	,Sharp5: {_hx_index:1,__enum__:"nx3.EKey"}
	,Sharp4: {_hx_index:2,__enum__:"nx3.EKey"}
	,Sharp3: {_hx_index:3,__enum__:"nx3.EKey"}
	,Sharp2: {_hx_index:4,__enum__:"nx3.EKey"}
	,Sharp1: {_hx_index:5,__enum__:"nx3.EKey"}
	,Natural: {_hx_index:6,__enum__:"nx3.EKey"}
	,Flat1: {_hx_index:7,__enum__:"nx3.EKey"}
	,Flat2: {_hx_index:8,__enum__:"nx3.EKey"}
	,Flat3: {_hx_index:9,__enum__:"nx3.EKey"}
	,Flat4: {_hx_index:10,__enum__:"nx3.EKey"}
	,Flat5: {_hx_index:11,__enum__:"nx3.EKey"}
	,Flat6: {_hx_index:12,__enum__:"nx3.EKey"}
};
...
var nx3_ELyricContinuation = $hxEnums["nx3.ELyricContinuation"] = { __ename__ : true, __constructs__ : ["Hyphen","Melisma"]
	,Hyphen: {_hx_index:0,__enum__:"nx3.ELyricContinuation"}
	,Melisma: {_hx_index:1,__enum__:"nx3.ELyricContinuation"}
};
var nx3_EModus = $hxEnums["nx3.EModus"] = { __ename__ : true, __constructs__ : ["Major","Minor"]
	,Major: {_hx_index:0,__enum__:"nx3.EModus"}
	,Minor: {_hx_index:1,__enum__:"nx3.EModus"}
};
var nx3_ENotationVariant = $hxEnums["nx3.ENotationVariant"] = { __ename__ : true, __constructs__ : ["Normal","Rythmic","RythmicSingleLevel","HeadsOnly","StavesOnly"]
	,Normal: {_hx_index:0,__enum__:"nx3.ENotationVariant"}
	,Rythmic: {_hx_index:1,__enum__:"nx3.ENotationVariant"}
	,RythmicSingleLevel: ($_=function(level) { return {_hx_index:2,level:level,__enum__:"nx3.ENotationVariant"}; },$_.__params__ = ["level"],$_)
	,HeadsOnly: {_hx_index:3,__enum__:"nx3.ENotationVariant"}
	,StavesOnly: {_hx_index:4,__enum__:"nx3.ENotationVariant"}
};
var nx3_ENoteArticulation = $hxEnums["nx3.ENoteArticulation"] = { __ename__ : true, __constructs__ : ["Staccato","Tenuto","Marcato"]
	,Staccato: {_hx_index:0,__enum__:"nx3.ENoteArticulation"}
	,Tenuto: {_hx_index:1,__enum__:"nx3.ENoteArticulation"}
	,Marcato: {_hx_index:2,__enum__:"nx3.ENoteArticulation"}
};
var nx3_ENoteAttributes = $hxEnums["nx3.ENoteAttributes"] = { __ename__ : true, __constructs__ : ["Arpeggio","Clef"]
	,Arpeggio: ($_=function(top,bottomY) { return {_hx_index:0,top:top,bottomY:bottomY,__enum__:"nx3.ENoteAttributes"}; },$_.__params__ = ["top","bottomY"],$_)
	,Clef: ($_=function(variant) { return {_hx_index:1,variant:variant,__enum__:"nx3.ENoteAttributes"}; },$_.__params__ = ["variant"],$_)
};
var nx3_ENoteType = $hxEnums["nx3.ENoteType"] = { __ename__ : true, __constructs__ : ["Note","Pause","BarPause","Tpl","Lyric","Chord","Dynamics","Pitch"]
	,Note: ($_=function(heads,variant,articulations,attributes) { return {_hx_index:0,heads:heads,variant:variant,articulations:articulations,attributes:attributes,__enum__:"nx3.ENoteType"}; },$_.__params__ = ["heads","variant","articulations","attributes"],$_)
	,Pause: ($_=function(level) { return {_hx_index:1,level:level,__enum__:"nx3.ENoteType"}; },$_.__params__ = ["level"],$_)
	,BarPause: {_hx_index:2,__enum__:"nx3.ENoteType"}
	,Tpl: ($_=function(level,sign,pause) { return {_hx_index:3,level:level,sign:sign,pause:pause,__enum__:"nx3.ENoteType"}; },$_.__params__ = ["level","sign","pause"],$_)
	,Lyric: ($_=function(text,offset,continuation,font) { return {_hx_index:4,text:text,offset:offset,continuation:continuation,font:font,__enum__:"nx3.ENoteType"}; },$_.__params__ = ["text","offset","continuation","font"],$_)
	,Chord: {_hx_index:5,__enum__:"nx3.ENoteType"}
	,Dynamics: {_hx_index:6,__enum__:"nx3.ENoteType"}
	,Pitch: ($_=function(level,midinote) { return {_hx_index:7,level:level,midinote:midinote,__enum__:"nx3.ENoteType"}; },$_.__params__ = ["level","midinote"],$_)
};
var nx3_ENoteVal = $hxEnums["nx3.ENoteVal"] = { __ename__ : true, __constructs__ : ["Nv1","Nv1dot","Nv1ddot","Nv1tri","Nv2","Nv2dot","Nv2ddot","Nv2tri","Nv4","Nv4dot","Nv4ddot","Nv4tri","Nv8","Nv8dot","Nv8ddot","Nv8tri","Nv16","Nv16dot","Nv16ddot","Nv16tri","Nv32","Nv32dot","Nv32ddot","Nv32tri"]
	,Nv1: {_hx_index:0,__enum__:"nx3.ENoteVal"}
	,Nv1dot: {_hx_index:1,__enum__:"nx3.ENoteVal"}
	,Nv1ddot: {_hx_index:2,__enum__:"nx3.ENoteVal"}
	,Nv1tri: {_hx_index:3,__enum__:"nx3.ENoteVal"}
	,Nv2: {_hx_index:4,__enum__:"nx3.ENoteVal"}
	,Nv2dot: {_hx_index:5,__enum__:"nx3.ENoteVal"}
	,Nv2ddot: {_hx_index:6,__enum__:"nx3.ENoteVal"}
	,Nv2tri: {_hx_index:7,__enum__:"nx3.ENoteVal"}
	,Nv4: {_hx_index:8,__enum__:"nx3.ENoteVal"}
	,Nv4dot: {_hx_index:9,__enum__:"nx3.ENoteVal"}
	,Nv4ddot: {_hx_index:10,__enum__:"nx3.ENoteVal"}
	,Nv4tri: {_hx_index:11,__enum__:"nx3.ENoteVal"}
	,Nv8: {_hx_index:12,__enum__:"nx3.ENoteVal"}
	,Nv8dot: {_hx_index:13,__enum__:"nx3.ENoteVal"}
	,Nv8ddot: {_hx_index:14,__enum__:"nx3.ENoteVal"}
	,Nv8tri: {_hx_index:15,__enum__:"nx3.ENoteVal"}
	,Nv16: {_hx_index:16,__enum__:"nx3.ENoteVal"}
	,Nv16dot: {_hx_index:17,__enum__:"nx3.ENoteVal"}
	,Nv16ddot: {_hx_index:18,__enum__:"nx3.ENoteVal"}
	,Nv16tri: {_hx_index:19,__enum__:"nx3.ENoteVal"}
	,Nv32: {_hx_index:20,__enum__:"nx3.ENoteVal"}
	,Nv32dot: {_hx_index:21,__enum__:"nx3.ENoteVal"}
	,Nv32ddot: {_hx_index:22,__enum__:"nx3.ENoteVal"}
	,Nv32tri: {_hx_index:23,__enum__:"nx3.ENoteVal"}
};
...
var nx3_EOctave = $hxEnums["nx3.EOctave"] = { __ename__ : true, __constructs__ : ["Normal","Up","Down"]
	,Normal: {_hx_index:0,__enum__:"nx3.EOctave"}
	,Up: {_hx_index:1,__enum__:"nx3.EOctave"}
	,Down: {_hx_index:2,__enum__:"nx3.EOctave"}
};
var nx3_EPartType = $hxEnums["nx3.EPartType"] = { __ename__ : true, __constructs__ : ["Normal","Lyrics","Tplrow","Tplchain","Dynamics","Chords","Ignore","Hidden","PitchRow","PitchChain"]
	,Normal: {_hx_index:0,__enum__:"nx3.EPartType"}
	,Lyrics: {_hx_index:1,__enum__:"nx3.EPartType"}
	,Tplrow: ($_=function(modus,octave) { return {_hx_index:2,modus:modus,octave:octave,__enum__:"nx3.EPartType"}; },$_.__params__ = ["modus","octave"],$_)
	,Tplchain: ($_=function(modus,octave) { return {_hx_index:3,modus:modus,octave:octave,__enum__:"nx3.EPartType"}; },$_.__params__ = ["modus","octave"],$_)
	,Dynamics: {_hx_index:4,__enum__:"nx3.EPartType"}
	,Chords: {_hx_index:5,__enum__:"nx3.EPartType"}
	,Ignore: {_hx_index:6,__enum__:"nx3.EPartType"}
	,Hidden: {_hx_index:7,__enum__:"nx3.EPartType"}
	,PitchRow: {_hx_index:8,__enum__:"nx3.EPartType"}
	,PitchChain: ($_=function(leveloffset) { return {_hx_index:9,leveloffset:leveloffset,__enum__:"nx3.EPartType"}; },$_.__params__ = ["leveloffset"],$_)
};
var nx3_EPosition = $hxEnums["nx3.EPosition"] = { __ename__ : true, __constructs__ : ["X","Y","XY","XYW"]
	,X: ($_=function(x) { return {_hx_index:0,x:x,__enum__:"nx3.EPosition"}; },$_.__params__ = ["x"],$_)
	,Y: ($_=function(y) { return {_hx_index:1,y:y,__enum__:"nx3.EPosition"}; },$_.__params__ = ["y"],$_)
	,XY: ($_=function(x,y) { return {_hx_index:2,x:x,y:y,__enum__:"nx3.EPosition"}; },$_.__params__ = ["x","y"],$_)
	,XYW: ($_=function(x,y,w) { return {_hx_index:3,x:x,y:y,w:w,__enum__:"nx3.EPosition"}; },$_.__params__ = ["x","y","w"],$_)
};
var nx3_ESign = $hxEnums["nx3.ESign"] = { __ename__ : true, __constructs__ : ["None","Natural","Flat","Sharp","DoubleFlat","DoubleSharp","ParNatural","ParFlat","ParSharp"]
	,None: {_hx_index:0,__enum__:"nx3.ESign"}
	,Natural: {_hx_index:1,__enum__:"nx3.ESign"}
	,Flat: {_hx_index:2,__enum__:"nx3.ESign"}
	,Sharp: {_hx_index:3,__enum__:"nx3.ESign"}
	,DoubleFlat: {_hx_index:4,__enum__:"nx3.ESign"}
	,DoubleSharp: {_hx_index:5,__enum__:"nx3.ESign"}
	,ParNatural: {_hx_index:6,__enum__:"nx3.ESign"}
	,ParFlat: {_hx_index:7,__enum__:"nx3.ESign"}
	,ParSharp: {_hx_index:8,__enum__:"nx3.ESign"}
};
var nx3_ETie = $hxEnums["nx3.ETie"] = { __ename__ : true, __constructs__ : ["Tie","Gliss"]
	,Tie: ($_=function(direction,level) { return {_hx_index:0,direction:direction,level:level,__enum__:"nx3.ETie"}; },$_.__params__ = ["direction","level"],$_)
	,Gliss: ($_=function(direction,levelLeft,levelRight) { return {_hx_index:1,direction:direction,levelLeft:levelLeft,levelRight:levelRight,__enum__:"nx3.ETie"}; },$_.__params__ = ["direction","levelLeft","levelRight"],$_)
};
var nx3_ETime = $hxEnums["nx3.ETime"] = { __ename__ : true, __constructs__ : ["Time2_2","Time3_2","Time4_2","Time2_4","Time3_4","Time4_4","Time5_4","Time6_4","Time7_4","Time2_8","Time3_8","Time4_8","Time5_8","Time6_8","Time7_8","Time9_8","Time12_8","TimeCommon","TimeAllabreve"]
	,Time2_2: {_hx_index:0,__enum__:"nx3.ETime"}
	,Time3_2: {_hx_index:1,__enum__:"nx3.ETime"}
	,Time4_2: {_hx_index:2,__enum__:"nx3.ETime"}
	,Time2_4: {_hx_index:3,__enum__:"nx3.ETime"}
	,Time3_4: {_hx_index:4,__enum__:"nx3.ETime"}
	,Time4_4: {_hx_index:5,__enum__:"nx3.ETime"}
	,Time5_4: {_hx_index:6,__enum__:"nx3.ETime"}
	,Time6_4: {_hx_index:7,__enum__:"nx3.ETime"}
	,Time7_4: {_hx_index:8,__enum__:"nx3.ETime"}
	,Time2_8: {_hx_index:9,__enum__:"nx3.ETime"}
	,Time3_8: {_hx_index:10,__enum__:"nx3.ETime"}
	,Time4_8: {_hx_index:11,__enum__:"nx3.ETime"}
	,Time5_8: {_hx_index:12,__enum__:"nx3.ETime"}
	,Time6_8: {_hx_index:13,__enum__:"nx3.ETime"}
	,Time7_8: {_hx_index:14,__enum__:"nx3.ETime"}
	,Time9_8: {_hx_index:15,__enum__:"nx3.ETime"}
	,Time12_8: {_hx_index:16,__enum__:"nx3.ETime"}
	,TimeCommon: {_hx_index:17,__enum__:"nx3.ETime"}
	,TimeAllabreve: {_hx_index:18,__enum__:"nx3.ETime"}
};
...
var nx3_EVoiceType = $hxEnums["nx3.EVoiceType"] = { __ename__ : true, __constructs__ : ["Normal","Barpause"]
	,Normal: {_hx_index:0,__enum__:"nx3.EVoiceType"}
	,Barpause: ($_=function(level) { return {_hx_index:1,level:level,__enum__:"nx3.EVoiceType"}; },$_.__params__ = ["level"],$_)
};
...
var nx3_PSystemStatus = $hxEnums["nx3.PSystemStatus"] = { __ename__ : true, __constructs__ : ["Ok","Problem"]
	,Ok: {_hx_index:0,__enum__:"nx3.PSystemStatus"}
	,Problem: ($_=function(code,msg) { return {_hx_index:1,code:code,msg:msg,__enum__:"nx3.PSystemStatus"}; },$_.__params__ = ["code","msg"],$_)
};
...
var nx3_action_EActionInfo = $hxEnums["nx3.action.EActionInfo"] = { __ename__ : true, __constructs__ : ["TargetXY"]
	,TargetXY: ($_=function(target,x,y) { return {_hx_index:0,target:target,x:x,y:y,__enum__:"nx3.action.EActionInfo"}; },$_.__params__ = ["target","x","y"],$_)
};
var nx3_action_EActionType = $hxEnums["nx3.action.EActionType"] = { __ename__ : true, __constructs__ : ["HeadAction","NoteAction"]
	,HeadAction: ($_=function(type,head,info) { return {_hx_index:0,type:type,head:head,info:info,__enum__:"nx3.action.EActionType"}; },$_.__params__ = ["type","head","info"],$_)
	,NoteAction: ($_=function(type,note,info) { return {_hx_index:1,type:type,note:note,info:info,__enum__:"nx3.action.EActionType"}; },$_.__params__ = ["type","note","info"],$_)
};
var nx3_action_EActivityType = $hxEnums["nx3.action.EActivityType"] = { __ename__ : true, __constructs__ : ["MouseDown","MouseUp","MouseOver","MouseOut"]
	,MouseDown: {_hx_index:0,__enum__:"nx3.action.EActivityType"}
	,MouseUp: {_hx_index:1,__enum__:"nx3.action.EActivityType"}
	,MouseOver: {_hx_index:2,__enum__:"nx3.action.EActivityType"}
	,MouseOut: {_hx_index:3,__enum__:"nx3.action.EActivityType"}
};
...
var nx3_qs_Qs1 = $hxEnums["nx3.qs.Qs1"] = { __ename__ : true, __constructs__ : ["S","B","P","V","N"]
	,S: ($_=function(s) { return {_hx_index:0,s:s,__enum__:"nx3.qs.Qs1"}; },$_.__params__ = ["s"],$_)
	,B: ($_=function(s) { return {_hx_index:1,s:s,__enum__:"nx3.qs.Qs1"}; },$_.__params__ = ["s"],$_)
	,P: ($_=function(s) { return {_hx_index:2,s:s,__enum__:"nx3.qs.Qs1"}; },$_.__params__ = ["s"],$_)
	,V: ($_=function(s) { return {_hx_index:3,s:s,__enum__:"nx3.qs.Qs1"}; },$_.__params__ = ["s"],$_)
	,N: ($_=function(s) { return {_hx_index:4,s:s,__enum__:"nx3.qs.Qs1"}; },$_.__params__ = ["s"],$_)
};
...
markdown_MarkdownRenderer.instance = new markdown_MarkdownRenderer();
markdown_QSyntax.REGEX = "/@score ([0-9a-zA-Z ]*)@/";
markdown_QInlineSyntaxRenderer.REGEX = "/@score ([0-9a-zA-Z ]*)@/";
