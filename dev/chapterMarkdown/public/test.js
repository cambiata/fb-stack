...
Index.prototype = {
	view: function() {
		...
		return [m.m("h1","Hello from Mithril " + State.counter),m.m("textarea",{ style : { width : "300px", height : "200px"}, value : State.md, oninput : function(e) {
			markdown_MithrilRendererCache.instance.clearCacheKey(id);
			return State.md = e.target.value;
		}}),markdown_MithrilRendererCache.instance.markdownToView(id,State.md,[new markdown_inlineRenderer_QInlineSyntaxRenderer()])];
	}
	,__class__: Index
};
