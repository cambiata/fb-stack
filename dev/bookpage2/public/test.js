...
var Main = function() {
	...
	m.mount(window.document.querySelector("#debug"),new Debug());
	haxe_Timer.delay(function() {
		...
		console.log("src/Main.hx:21:","QSyntaxRenderer loaded");
		m.redraw();
		return;
	},3000);
};
...
Index.prototype = {
	view: function() {
		...
		return [m.m("h1","Hello from Mithril " + Model.instance.counter),m.m("button",{ onclick : function(e) {
			m.mount(window.document.querySelector("#bookheader"),new Test());
			m.mount(window.document.querySelector("#bookleft"),new BookTOC());
			m.mount(window.document.querySelector("#chaptercontent"),new ChapterContent());
			m.mount(window.document.querySelector("#subchaptercontent"),new SubchapterContent());
			return;
		}},"ClickMe"),m.m("button",{ onclick : function(e1) {
			m.mount(window.document.querySelector("#bookheader"),new Test2());
			return;
		}},"ClickMe")];
	}
	,__class__: Index
...
Test.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		return [m.m("h3","Test " + Model.instance.counter)];
	}
	,__class__: Test
};
var Test2 = function() {
};
$hxClasses["Test2"] = Test2;
Test2.__name__ = ["Test2"];
Test2.__interfaces__ = [mithril_Mithril];
Test2.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		return [m.m("h1","Test2 " + Model.instance.counter)];
	}
	,__class__: Test2
};
var BookModel = function() {
};
$hxClasses["BookModel"] = BookModel;
BookModel.__name__ = ["BookModel"];
BookModel.prototype = {
	set_book: function(book) {
		this.book = book;
		this.set_chapter(null);
		this.set_subchapter(null);
		m.redraw();
		return book;
	}
	...
	,set_subchapter: function(subchapter) {
		this.subchapter = subchapter;
		m.redraw();
		return subchapter;
	}
	,randomBook: function() {
		this.set_book(data_ContentUtils.randomBooks(1)[0]);
	}
	,init: function() {
		this.randomBook();
	}
	...
	,__class__: BookModel
	,__properties__: {set_subchapter:"set_subchapter",set_chapter:"set_chapter",set_book:"set_book"}
};
var BookTOC = function() {
};
$hxClasses["BookTOC"] = BookTOC;
BookTOC.__name__ = ["BookTOC"];
BookTOC.__interfaces__ = [mithril_Mithril];
BookTOC.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		return m.m("#booktoc",BookModel.instance.getBook().chapters.map(function(ch) {
			var selected = BookModel.instance.getChapter() == ch ? ".selected" : "";
			return m.m("button.#booktocitem" + selected,{ onclick : function(e) {
				console.log("src/Main.hx:149:","click");
				BookModel.instance.set_chapter(ch);
				m.redraw();
				return;
			}},ch.title);
		}));
...
var ChapterTOC = function() {
};
$hxClasses["ChapterTOC"] = ChapterTOC;
ChapterTOC.__name__ = ["ChapterTOC"];
ChapterTOC.__interfaces__ = [mithril_Mithril];
ChapterTOC.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		return m.m("#chaptertoc",BookModel.instance.getChapter().subchapters.map(function(sub) {
			var selected = BookModel.instance.getSubchapter() == sub ? ".selected" : "";
			return m.m("button.#chaptertocitem" + selected,{ onclick : function(e) {
				return BookModel.instance.set_subchapter(sub);
			}},sub.title);
		}));
	}
	,__class__: ChapterTOC
};
var ChapterContent = function() {
};
$hxClasses["ChapterContent"] = ChapterContent;
ChapterContent.__name__ = ["ChapterContent"];
ChapterContent.__interfaces__ = [mithril_Mithril];
ChapterContent.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
	...
	,__class__: ChapterContent
};
var SubchapterContent = function() {
};
$hxClasses["SubchapterContent"] = SubchapterContent;
SubchapterContent.__name__ = ["SubchapterContent"];
SubchapterContent.__interfaces__ = [mithril_Mithril];
SubchapterContent.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		...
		return [new ChapterTOC().view(),markdown_MithrilRendererCache.instance.markdownToView(id,md,[new markdown_inlineRenderer_QInlineSyntaxRenderer()])];
	}
	,__class__: SubchapterContent
};
var Debug = function() {
};
$hxClasses["Debug"] = Debug;
Debug.__name__ = ["Debug"];
Debug.__interfaces__ = [mithril_Mithril];
Debug.prototype = {
	view: function() {
		if(arguments.length > 0 && arguments[0].tag != this) return arguments[0].tag.view.apply(arguments[0].tag, arguments);
		return [m.m("details",m.m("p","" + Std.string(BookModel.instance.getBook()))),m.m("details",m.m("p","" + Std.string(BookModel.instance.getChapter()))),m.m("details",m.m("p","" + Std.string(BookModel.instance.getSubchapter())))];
	}
	,__class__: Debug
};
...
$hxClasses["TypeModel"] = TypeModel;
TypeModel.__name__ = ["TypeModel"];
TypeModel.prototype = {
	createUI: function(targetSelector,type) {
		...
		case data_ScorxmixerChaptertype:
			...
			storage_StorageSource.instance.getUrls(paths).then(function(_urls) {
				var urls = _urls;
				console.log("src/Main.hx:249:",urls);
		...
		case data_VideoChaptertype:
			...
			storage_StorageSource.instance.getUrl("/test/Klaver.mp4").then(function(url) {
				console.log("src/Main.hx:229:",url);
				return el1.src = url;
			});
			break;
		default:
...
var ChapterTypeModel = function() {
	TypeModel.call(this);
};
$hxClasses["ChapterTypeModel"] = ChapterTypeModel;
ChapterTypeModel.__name__ = ["ChapterTypeModel"];
ChapterTypeModel.__super__ = TypeModel;
ChapterTypeModel.prototype = $extend(TypeModel.prototype,{
	...
	,__class__: ChapterTypeModel
});
var SubchapterTypeModel = function() {
	TypeModel.call(this);
};
$hxClasses["SubchapterTypeModel"] = SubchapterTypeModel;
SubchapterTypeModel.__name__ = ["SubchapterTypeModel"];
SubchapterTypeModel.__super__ = TypeModel;
SubchapterTypeModel.prototype = $extend(TypeModel.prototype,{
	setChapter: function(chapter) {
		if(chapter == null) {
			return;
		}
...
nx3_NHead.prototype = {
	...
	,getTag: function() {
		...
		return "&" + nx3_NTags.headTypetag(this.type) + level + nx3_NTags.headSignTag(this.sign) + (this.tie != null ? "_" : "");
	}
	,__class__: nx3_NHead
};
...
nx3_NPart.prototype = {
	...
	,getTag: function() {
		...
		var key = nx3_NTags.keyTag(this.key);
		return "!" + nx3_NTags.npartTypeTag(this.type) + voicestags + clef + (key + nx3_NTags.displayALNTag(this.keyDisplay));
	}
	,__class__: nx3_NPart
	,__properties__: {get_length:"get_length"}
};
...
ChapterTypeModel.instance = new ChapterTypeModel();
SubchapterTypeModel.instance = new SubchapterTypeModel();
Xml.Element = 0;
Xml.PCData = 1;
Xml.CData = 2;
Xml.Comment = 3;
