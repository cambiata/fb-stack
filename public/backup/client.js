...
var ui_RosettaChapter, ui_PdfChapter, ui_VideoChapter, ui_PitchChapter, ui_ScorxmixerChapter, ui_render_QSyntaxRenderer;
...
Client.prototype = {
	initBundledClasses: function() {
		haxe_Timer.delay(function() {
			Promise.all([Require.module("ui_RosettaChapter").then(function(id) {
				var _ = ui_RosettaChapter = $s.ui_RosettaChapter;
				return id;
			}),Require.module("ui_PdfChapter").then(function(id1) {
				var _1 = ui_PdfChapter = $s.ui_PdfChapter;
				return id1;
			}),Require.module("ui_VideoChapter").then(function(id2) {
				var _2 = ui_VideoChapter = $s.ui_VideoChapter;
				return id2;
			}),Require.module("ui_PitchChapter").then(function(id3) {
				var _3 = ui_PitchChapter = $s.ui_PitchChapter;
				return id3;
			}),Require.module("ui_ScorxmixerChapter").then(function(id4) {
				var _4 = ui_ScorxmixerChapter = $s.ui_ScorxmixerChapter;
				return id4;
			})]).then(function(_5) {
				haxe_Log.trace("ALL LOADED",{ fileName : "src/Client.hx", lineNumber : 34, className : "Client", methodName : "initBundledClasses"});
			...
			return Require.module("ui_render_QSyntaxRenderer").then(function(id5) {
				var _6 = ui_render_QSyntaxRenderer = $s.ui_render_QSyntaxRenderer;
				return id5;
			}).then(function(_7) {
				...
				haxe_Log.trace("QSyntaxRenderer loaded",{ fileName : "src/Client.hx", lineNumber : 47, className : "Client", methodName : "initBundledClasses"});
				m.redraw();
				return;
			});
		},2000);
...
data_ContentLoader.prototype = {
	loadContent: function() {
		return data_ApiCalls.getRequest("/api/content-tree").then(function(item) {
			...
			haxe_Log.trace("ContentLoader loadContent error: " + e,{ fileName : "src/data/ContentLoader.hx", lineNumber : 380, className : "data.ContentLoader", methodName : "loadContent"});
			return;
		});
	}
...
data_StorageMap.prototype = {
	get: function(src) {
		...
		if(__map_reserved[src] != null ? _this.existsReserved(src) : _this.h.hasOwnProperty(src)) {
			haxe_Log.trace("Get " + src + " from cache",{ fileName : "src/data/StorageMap.hx", lineNumber : 23, className : "data.StorageMap", methodName : "get"});
			var _this1 = this.map;
		...
		haxe_Log.trace(src + " does not exist",{ fileName : "src/data/StorageMap.hx", lineNumber : 26, className : "data.StorageMap", methodName : "get"});
		firebase.storage().ref(src).getDownloadURL().then(function(downloadUrl) {
			haxe_Log.trace("found " + src + ":" + downloadUrl,{ fileName : "src/data/StorageMap.hx", lineNumber : 29, className : "data.StorageMap", methodName : "get"});
			...
			haxe_Log.trace("error " + e,{ fileName : "src/data/StorageMap.hx", lineNumber : 34, className : "data.StorageMap", methodName : "get"});
			m.redraw();
		...
		while(_g < mdNodes.length) {
			...
			case markdown_inlineRenderer_SyntaxRendererNode:
				...
				try {
					...
					haxe_Log.trace("error: " + Std.string((e instanceof js__$Boot_HaxeError) ? e.val : e),{ fileName : "src/markdown/MithrilRenderer.hx", lineNumber : 82, className : "markdown.MithrilRenderer", methodName : "buildView"});
				}
				break;
			}
		}
...
markdown_MithrilRendererCache.prototype = {
	clearCache: function() {
		...
		while(key.hasNext()) {
			var key1 = key.next();
			haxe_Log.trace("clear markdown dache",{ fileName : "src/markdown/MithrilRendererCache.hx", lineNumber : 16, className : "markdown.MithrilRendererCache", methodName : "clearCache"});
	...
	,markdownToView: function(id,md,syntaxRenderers) {
		...
		haxe_Log.trace("save " + id + " to cache",{ fileName : "src/markdown/MithrilRendererCache.hx", lineNumber : 35, className : "markdown.MithrilRendererCache", methodName : "markdownToView"});
...
markdown_MithrilTools.buildView = function(mdNodes,parent) {
	...
	while(_g < mdNodes.length) {
		...
		case ui_StringRenderNode:
			...
			break;
		default:
			haxe_Log.trace("OTHER NODE",{ fileName : "src/markdown/MithrilTools.hx", lineNumber : 124, className : "markdown.MithrilTools", methodName : "buildView"});
		}
	}
	return parent;
};
	...
	,editChapterView: function(chapter) {
		...
		try {
			return m.m("details",[m.m("textarea",{ style : { width : "100%", height : "300px"}, oninput : function(e) {
				...
				haxe_Log.trace(chapter.dbpath,{ fileName : "src/ui/Bookpage.hx", lineNumber : 155, className : "ui.Bookpage", methodName : "editChapterView"});
				return firebase.database().ref(chapter.dbpath).update({ text : chapter.text},function(e2) {
					haxe_Log.trace("after update " + Std.string(e2),{ fileName : "src/ui/Bookpage.hx", lineNumber : 157, className : "ui.Bookpage", methodName : "editChapterView"});
					return;
				});
			}},"Save")]);
		} catch( e3 ) {
...
ui_ChapterTypeViewCache.prototype = {
	...
	,getTypeView: function(chapter) {
		...
		if(__map_reserved[path] != null ? _this.existsReserved(path) : _this.h.hasOwnProperty(path)) {
			haxe_Log.trace("get " + path + " from cache",{ fileName : "src/ui/ChapterTypeViewCache.hx", lineNumber : 34, className : "ui.ChapterTypeViewCache", methodName : "getTypeView"});
			var _this1 = this.cache;
...
ui_UIFooter.prototype = {
	view: function() {
		...
		var tmp8 = m.m("button",{ onclick : function(e8) {
			haxe_Log.trace(JSON.stringify(dataclass_TypedJsonConverter.toTypedJson(data_ContentModel.instance.content)),{ fileName : "src/ui/ClientUI.hx", lineNumber : 85, className : "ui.UIFooter", methodName : "view"});
			return;
		}},"Trace content");
		...
		return [tmp,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,m.m("select",{ onchange : function(e9) {
			haxe_Log.trace(e9.target.selectedIndex,{ fileName : "src/ui/ClientUI.hx", lineNumber : 91, className : "ui.UIFooter", methodName : "view"});
			...
			return data_ApiCalls.getRequest("/api/content-tree").then(function(result) {
				...
				haxe_Log.trace(content.rooms,{ fileName : "src/ui/ClientUI.hx", lineNumber : 111, className : "ui.UIFooter", methodName : "view"});
				var c = dataclass_JsonConverter.fromJson(data_Content,content);
				haxe_Log.trace("---------------------",{ fileName : "src/ui/ClientUI.hx", lineNumber : 136, className : "ui.UIFooter", methodName : "view"});
				haxe_Log.trace(JSON.stringify(dataclass_TypedJsonConverter.toTypedJson(c)),{ fileName : "src/ui/ClientUI.hx", lineNumber : 138, className : "ui.UIFooter", methodName : "view"});
				return;
			})["catch"](function(e11) {
				haxe_Log.trace(e11,{ fileName : "src/ui/ClientUI.hx", lineNumber : 140, className : "ui.UIFooter", methodName : "view"});
				return;
			});
		}},"ClickMe"),m.m("button",{ onclick : function(e12) {
			haxe_Log.trace(JSON.stringify(dataclass_TypedJsonConverter.toTypedJson(data_ContentModel.instance.content)),{ fileName : "src/ui/ClientUI.hx", lineNumber : 147, className : "ui.UIFooter", methodName : "view"});
			return;
		}},"Tree to json")];
	}
...
ui_media_StorageItem.prototype = {
	view: function() {
		...
		haxe_Log.trace("storageUrl:" + storageUrl,{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 18, className : "ui.media.StorageItem", methodName : "view"});
		var itemView = null;
	...
	,getUploadView: function(src) {
		...
		var tmp1 = m.m("input",{ type : "file", id : "file", onchange : function(e) {
			...
			haxe_Log.trace(ui_media_StorageItem.file,{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 58, className : "ui.media.StorageItem", methodName : "getUploadView"});
			return;
		}});
		var tmp2 = m.m("button",{ onclick : function(e1) {
			haxe_Log.trace("upload",{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 63, className : "ui.media.StorageItem", methodName : "getUploadView"});
			haxe_Log.trace(ui_media_StorageItem.file,{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 64, className : "ui.media.StorageItem", methodName : "getUploadView"});
			if(ui_media_StorageItem.file == null) {
				return;
			}
			var fileref = src;
			var storageRef = firebase.storage().ref(fileref);
			haxe_Log.trace(storageRef,{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 70, className : "ui.media.StorageItem", methodName : "getUploadView"});
			storageRef.put(ui_media_StorageItem.file).on("state_changed",function(snap) {
				haxe_Log.trace("uploading " + src + "...",{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 74, className : "ui.media.StorageItem", methodName : "getUploadView"});
				return null;
			},function(error) {
				haxe_Log.trace("error2 " + e1,{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 77, className : "ui.media.StorageItem", methodName : "getUploadView"});
				return;
			},function() {
				haxe_Log.trace("hehe",{ fileName : "src/ui/media/StorageItem.hx", lineNumber : 80, className : "ui.media.StorageItem", methodName : "getUploadView"});
				m.redraw();
				return;
			});
			return;
